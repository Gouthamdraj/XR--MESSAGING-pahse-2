...
const SERVER_URL = 'https://4f48b9cf28cc.ngrok-free.app'; 
...
function handleSignalMessage(data) {
  ...
  // ✅ Console-only transcript logging
  if (type === 'transcript_console') {
    const p = data.data || {};
    const fin = p.final ? 'final' : 'partial';
    console.log(
      `[TRANSCRIPT] ${p.timestamp} ${fin} ${p.from} -> ${p.to}: "${p.text}"`
    );
...
// ===========================================================transcription and toggle button version ====================================================================================
...
// console.log('[CONFIG] Loading configuration');
// // Update to your server URL as needed:
// // const SERVER_URL = 'https://6dadc7bb887f.ngrok-free.app';  
// const SERVER_URL = 'https://xr-messaging-geexbheshbghhab7.centralindia-01.azurewebsites.net';
...
//     // Debounced flush: if more finals arrive soon, keep merging; else print once.
